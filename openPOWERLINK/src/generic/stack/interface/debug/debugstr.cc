...
// text strings for POWERLINK event sinks
        static const char* eventSinkStr_l[] = { "EventSinkSync",
                "EventSinkNmtk", "EventSinkDllk", "EventSinkDlluCal",
                "EventSinkDllkCal", "EventSinkPdok", "EventSinkNmtu",
                "EventSinkErrk", "EventSinkErru", "EventSinkSdoAsySeq",
                "EventSinkNmtMnu", "0x0b",                     // reserved
...
// text strings for POWERLINK states
        static tNmtStateInfo nmtStateInfo_l[] =
                { { NmtStateE::kNmtGsOff, "NmtGsOff" }, {
                        NmtStateE::kNmtGsInitialising, "NmtGsInitializing" }, {
                        NmtStateE::kNmtGsResetApplication,
                        "NmtGsResetApplication" }, {
                        NmtStateE::kNmtGsResetCommunication,
                        "NmtGsResetCommunication" }, {
                        NmtStateE::kNmtGsResetConfiguration,
                        "NmtGsResetConfiguration" }, {
                        NmtStateE::kNmtCsNotActive, "NmtCsNotActive" },
                        { NmtStateE::kNmtCsPreOperational1,
                                "NmtCsPreOperational1" }, {
                                NmtStateE::kNmtCsStopped, "NmtCsStopped" }, {
                                NmtStateE::kNmtCsPreOperational2,
                                "NmtCsPreOperational2" }, {
                                NmtStateE::kNmtCsReadyToOperate,
                                "NmtCsReadyToOperate" },
                        { NmtStateE::kNmtCsOperational, "NmtCsOperational" }, {
                                NmtStateE::kNmtCsBasicEthernet,
                                "NmtCsBasicEthernet" }, {
                                NmtStateE::kNmtMsNotActive, "NmtMsNotActive" },
                        { NmtStateE::kNmtMsPreOperational1,
                                "NmtMsPreOperational1" }, {
                                NmtStateE::kNmtMsPreOperational2,
                                "NmtMsPreOperational2" }, {
                                NmtStateE::kNmtMsReadyToOperate,
                                "NmtMsReadyToOperate" },
                        { NmtStateE::kNmtMsOperational, "NmtMsOperational" }, {
                                NmtStateE::kNmtMsBasicEthernet,
                                "NmtMsBasicEthernet" },
                        { NmtStateE::kNmtRmsNotActive, "NmtRmsNotActive" },
                        { NmtStateE::kNmtStateInvalid, "Invalid NMT State" }, };

// text strings for API events
        static tApiEventInfo apiEventInfo_l[] = { {
                ApiEvent::kOplkApiEventUserDef, "User defined" }, {
                ApiEvent::kOplkApiEventNmtStateChange, "NMT state change" }, {
                ApiEvent::kOplkApiEventCriticalError,
                "CRITICAL error -> stack halted" }, {
                ApiEvent::kOplkApiEventWarning, "Warning" }, {
                ApiEvent::kOplkApiEventHistoryEntry, "History entry" }, {
                ApiEvent::kOplkApiEventNode, "Node event" }, {
                ApiEvent::kOplkApiEventBoot, "Boot event" }, {
                ApiEvent::kOplkApiEventSdo, "SDO event" }, {
                ApiEvent::kOplkApiEventObdAccess, "OBD access" }, {
                ApiEvent::kOplkApiEventCfmProgress, "CFM progress" }, {
                ApiEvent::kOplkApiEventCfmResult, "CFM result" }, {
                ApiEvent::kOplkApiEventReceivedAsnd, "Received ASnd" }, {
                ApiEvent::kOplkApiEventPdoChange, "PDO change" } };

// text strings for values of type tOplkError
        static tRetValInfo retValInfo_l[] =
                {
                /* area for generic errors 0x0000 - 0x000F */
                { Error::kErrorOk, "No error / function call successful" }, {
                        Error::kErrorIllegalInstance,
                        "The called instance does not exist" }, {
                        Error::kErrorInvalidInstanceParam,
                        "Invalid instance parameter" },
                        { Error::kErrorNoFreeInstance,
                                "Xxx_addInstance was called but no free instance is available" },
                        { Error::kErrorWrongSignature,
                                "Wrong signature while writing to object 0x1010 or 0x1011" },
                        { Error::kErrorInvalidOperation,
                                "Operation not allowed in this situation" }, {
                                Error::kErrorInvalidNodeId,
                                "Invalid NodeId was specified" },
                        { Error::kErrorNoResource,
                                "Resource could not be created (Windows, PxROS, ...)" },
                        { Error::kErrorShutdown, "Stack is shutting down" }, {
                                Error::kErrorReject,
                                "Reject the subsequent command" }, {
                                Error::kErrorRetry, "Retry this command" },
                        { Error::kErrorInvalidEvent,
                                "Invalid event was posted to process function" },
                        { Error::kErrorGeneralError, "General error" },
                        { Error::kErrorFeatureMismatch,
                                "Features of user and kernel stack are mismatched" },

                        /* area for EDRV module 0x0010 - 0x001F */
                        { Error::kErrorEdrvNoFreeTxDesc,
                                "No free Tx descriptor available" }, {
                                Error::kErrorEdrvInvalidCycleLen,
                                "Invalid cycle length (e.g. 0)" }, {
                                Error::kErrorEdrvInit, "Initialisation error" },
                        { Error::kErrorEdrvNoFreeBufEntry,
                                "No free entry in internal buffer table for Tx frames" },
                        { Error::kErrorEdrvBufNotExisting,
                                "Specified Tx buffer does not exist" }, {
                                Error::kErrorEdrvInvalidRxBuf,
                                "Specified Rx buffer is invalid" }, {
                        ...
                        { Error::kErrorDllOutOfMemory, "Out of memory" }, {
                                Error::kErrorDllIllegalHdl,
                                "Illegal handle for a TxFrame was passed" },
                        { Error::kErrorDllCbAsyncRegistered,
                                "Handler for non-POWERLINK frames had already been registered before" },
                        { Error::kErrorDllAsyncSyncReqFull,
                                "Buffer for SyncRequests is full" },
                        { Error::kErrorDllAsyncTxBufferEmpty,
                                "Transmit buffer for asynchronous frames is empty" },
                        { Error::kErrorDllAsyncTxBufferFull,
                                "Transmit buffer for asynchronous frames is full" },
                        { Error::kErrorDllNoNodeInfo,
                                "MN: Too less space in the internal node info structure" },
                        { Error::kErrorDllInvalidParam,
                                "Invalid parameters passed to function" }, {
                                Error::kErrorDllInvalidAsndServiceId,
                                "Invalid AsndServiceId specified" }, {
                                Error::kErrorDllTxBufNotReady,
                                "TxBuffer (e.g. for PReq) is not ready yet" },
                        { Error::kErrorDllTxFrameInvalid,
                                "TxFrame (e.g. for PReq) is invalid or does not exist" },

                        /* area for OBD module 0x0030 - 0x003F */
                        { Error::kErrorObdIllegalPart, "Unknown OD part" }, {
                                Error::kErrorObdIndexNotExist,
                                "Object index does not exist in the OD" }, {
                                Error::kErrorObdSubindexNotExist,
                                "Subindex does not exist in the object index" },
                        { Error::kErrorObdReadViolation,
                                "Read access to a write-only object" }, {
                                Error::kErrorObdWriteViolation,
                                "Write access to a read-only object" }, {
                                Error::kErrorObdAccessViolation,
                                "Access not allowed" }, {
                                Error::kErrorObdUnknownObjectType,
                                "Object type not defined or unknown" }, {
                                Error::kErrorObdVarEntryNotExist,
                                "Object does not contain VarEntry structure" },
                        { Error::kErrorObdValueTooLow,
                                "Value to write to the object is too low" }, {
                                Error::kErrorObdValueTooHigh,
                                "Value to write to the object is too high" }, {
                                Error::kErrorObdValueLengthError,
                                "Value to write is too long or too short" }, {
                                Error::kErrorObdErrnoSet,
                                "File I/O error occurred and errno is set" },
                        { Error::kErrorObdInvalidDcf,
                                "Device configuration file (CDC) is not valid" },
                        { Error::kErrorObdOutOfMemory, "Out of memory" },
                        { Error::kErrorObdNoConfigData,
                        ...
                        { Error::kErrorNmtInvalidFramePointer,
                                "Pointer to the frame is not valid" }, {
                                Error::kErrorNmtInvalidEvent,
                                "Invalid event sent to NMT module" }, {
                                Error::kErrorNmtInvalidState,
                                "Unknown state in NMT state machine" }, {
                                Error::kErrorNmtInvalidParam,
                                "Invalid parameters specified" }, {
                                Error::kErrorNmtSyncReqRejected,
                                "SyncReq could not be issued" },

                        /* area for SDO/UDP module 0x0050 - 0x005F */
                        { Error::kErrorSdoUdpMissCb,
                                "Missing callback-function pointer during init of module" },
                        { Error::kErrorSdoUdpNoSocket,
                                "Error during init of socket" }, {
                                Error::kErrorSdoUdpSocketError,
                                "Error during usage of socket" }, {
                                Error::kErrorSdoUdpThreadError,
                                "Error during start of listen thread" }, {
                                Error::kErrorSdoUdpNoFreeHandle,
                                "No free connection handle for UDP" }, {
                                Error::kErrorSdoUdpSendError,
                                "Error during sending the frame" }, {
                                Error::kErrorSdoUdpInvalidHdl,
                                "The connection handle is invalid" },

                        /* area for SDO Sequence layer module 0x0060 - 0x006F */
                        { Error::kErrorSdoSeqMissCb,
                                "No callback-function assigned" }, {
                                Error::kErrorSdoSeqNoFreeHandle,
                                "No free handle for connection" }, {
                                Error::kErrorSdoSeqInvalidHdl,
                                "Invalid handle in SDO sequence layer" }, {
                                Error::kErrorSdoSeqUnsupportedProt,
                                "Unsupported protocol selected" }, {
                                Error::kErrorSdoSeqNoFreeHistory,
                                "No free history entry" }, {
                                Error::kErrorSdoSeqFrameSizeError,
                        ...
                        { Error::kErrorSdoSeqConnectionBusy,
                                "Connection is busy -> retry later" }, {
                                Error::kErrorSdoSeqInvalidEvent,
                                "Invalid event received" },

                        /* area for SDO Command Layer module 0x0070 - 0x007F */
                        { Error::kErrorSdoComUnsupportedProt,
                                "Unsupported Protocol selected" }, {
                                Error::kErrorSdoComNoFreeHandle,
                                "No free handle for connection" }, {
                                Error::kErrorSdoComInvalidServiceType,
                                "Invalid SDO service type specified" }, {
                                Error::kErrorSdoComInvalidHandle,
                                "Handle invalid" },
                        { Error::kErrorSdoComInvalidSendType,
                                "The passed frame type is invalid for sending" },
                        ...
                        { Error::kErrorSdoComHandleExists,
                                "Handle to same node already exists" }, {
                                Error::kErrorSdoComHandleBusy,
                                "Transfer via this handle is already running" },
                        { Error::kErrorSdoComInvalidParam,
                                "Invalid parameters passed to function" },

                        /* area for openPOWERLINK event module 0x0080 - 0x008F */
                        { Error::kErrorEventUnknownSink,
                                "Unknown sink for event" }, {
                                Error::kErrorEventPostError,
                                "Error during posting the event" }, {
                                Error::kErrorEventReadError,
                                "Error during reading the event from queue" }, {
                                Error::kErrorEventWrongSize,
                                "Event arg has wrong size" },

                        /* area for openPOWERLINK timer module 0x0090 - 0x009F */
                        { Error::kErrorTimerInvalidHandle,
                                "Invalid handle for timer" }, {
                                Error::kErrorTimerNoTimerCreated,
                                "No timer was created because of an error" }, {
                                Error::kErrorTimerThreadError,
                                "Process thread could not be created" },

                        /* area for openPOWERLINK SDO/Asnd module 0x00A0 - 0x0AF */
                        { Error::kErrorSdoAsndInvalidNodeId,
                                "Node id is invalid" }, {
                                Error::kErrorSdoAsndNoFreeHandle,
                                "No free handle for connection" }, {
                                Error::kErrorSdoAsndInvalidHandle,
                                "Handle for connection is invalid" },

                        /* area for PDO module 0x00B0 - 0x00BF  */
                        { Error::kErrorPdoNotExist,
                                "Selected PDO does not exist" },
                        { Error::kErrorPdoLengthExceeded,
                        ...
                        { Error::kErrorPdoErrorMapp, "Invalid PDO mapping" },
                        { Error::kErrorPdoVarNotFound,
                                "The referenced object in a PDO mapping does not exist" },
                        { Error::kErrorPdoVarNotMappable,
                        ...
                        { Error::kErrorPdoTooManyPdos,
                                "Too many PDOs are existing" },

                        /* Configuration manager module 0x00C0 - 0x00CF */
                        { Error::kErrorCfmConfigError,
                                "Error in configuration manager" },
                        { Error::kErrorCfmSdocTimeOutError,
                                "Error in configuration manager due to an SDO timeout" },
                        { Error::kErrorCfmInvalidDcf,
                                "Device configuration file (CDC) is not valid" },
                        { Error::kErrorCfmUnsupportedDcf,
                                "Unsupported DCF format" }, {
                                Error::kErrorCfmConfigWithErrors,
                                "Configuration finished with errors" }, {
                                Error::kErrorCfmNoFreeConfig,
                                "No free configuration entry" }, {
                                Error::kErrorCfmNoConfigData,
                        ...
                        { Error::kErrorObdStoreHwError,
                                "HW error while accessing non-volatile memory" },
                        { Error::kErrorObdStoreInvalidState,
                                "Non-volatile memory is in invalid state (nothing saved)" },
                        { Error::kErrorObdStoreDataLimitExceeded,
                                "Data count is less than the expected size" }, {
                                Error::kErrorObdStoreDataObsolete,
                                "Data stored in the archive is obsolete" },
                        ...
                        { Error::kErrorApiPIAlreadyAllocated,
                                "Process image is already allocated" }, {
                                Error::kErrorApiPIOutOfMemory,
                        ...
                        { Error::kErrorApiPINotAllocated,
                                "Process image is not allocated" }, {
                                Error::kErrorApiPIJobQueueFull,
                                "Process image: job queue is full" }, {
                                Error::kErrorApiPIJobQueueEmpty,
                                "Process image: job queue is empty" }, {
                                Error::kErrorApiPIInvalidJobSize,
                        ...
                        { Error::kErrorApiNotInitialized,
                                "API called but stack is not initialized/running" }, };

        static const tEmergErrCodeInfo emergErrCodeInfo_l[] = { { E_NO_ERROR,
                "E_NO_ERROR" },
                ...
                E_DLL_COLLISION_TH, "E_DLL_COLLISION_TH" }, { E_DLL_CRC_TH,
                        "E_DLL_CRC_TH " }, {
                E_DLL_LOSS_OF_LINK, "E_DLL_LOSS_OF_LINK", }, { E_DLL_MAC_BUFFER,
                        "E_DLL_MAC_BUFFER", },
                ...
                { E_PDO_SHORT_RX, "E_PDO_SHORT_RX" }, { E_PDO_MAP_VERS,
                        "E_PDO_MAP_VERS" }, { E_NMT_ASND_MTU_DIF,
                        "E_NMT_ASND_MTU_DIF" }, { E_NMT_ASND_MTU_LIM,
                        "E_NMT_ASND_MTU_LIM" }, { E_NMT_ASND_TX_LIM,
                        "E_NMT_ASND_TX_LIM" },

                // 0x823x Timing errors
                { E_NMT_CYCLE_LEN, "E_NMT_CYCLE_LEN" }, { E_DLL_CYCLE_EXCEED,
                        "E_DLL_CYCLE_EXCEED" }, {
                E_DLL_CYCLE_EXCEED_TH, "E_DLL_CYCLE_EXCEED_TH" }, {
                E_NMT_IDLE_LIM, "E_NMT_IDLE_LIM" }, {
                E_DLL_JITTER_TH, "E_DLL_JITTER_TH" }, { E_DLL_LATE_PRES_TH,
                        "E_DLL_LATE_PRES_TH" }, {
                E_NMT_PREQ_CN, "E_NMT_PREQ_CN" }, { E_NMT_PREQ_LIM,
                        "E_NMT_PREQ_LIM" }, { E_NMT_PRES_CN, "E_NMT_PRES_CN" },
                ...
                E_DLL_LOSS_PRES_TH, "E_DLL_LOSS_PRES_TH" }, { E_DLL_LOSS_SOA_TH,
                        "E_DLL_LOSS_SOA_TH" }, {
                E_DLL_LOSS_SOC_TH, "E_DLL_LOSS_SOC_TH" },

                // 0x84xx BootUp Errors
                { E_NMT_BA1, "E_NMT_BA1" }, { E_NMT_BA1_NO_MN_SUPPORT,
                        "E_NMT_BA1_NO_MN_SUPPORT" },
                { E_NMT_BPO1, "E_NMT_BPO1" }, { E_NMT_BPO1_GET_IDENT,
                        "E_NMT_BPO1_GET_IDENT" }, { E_NMT_BPO1_DEVICE_TYPE,
                        "E_NMT_BPO1_DEVICE_TYPE" }, { E_NMT_BPO1_VENDOR_ID,
                ...
                E_NMT_BPO2, "E_NMT_BPO2" }, { E_NMT_BRO, "E_NMT_BRO" }, {
...
// text strings for abort codes
        static tAbortCodeInfo abortCodeInfo_g[] =
                ...
                SDO_AC_UNKNOWN_COMMAND_SPECIFIER,
                        ...
                        { SDO_AC_PDO_LENGTH_EXCEEDED,
                                "SDO_AC_PDO_LENGTH_EXCEEDED" }, {
                        SDO_AC_GEN_PARAM_INCOMPATIBILITY,
                                "SDO_AC_GEN_PARAM_INCOMPATIBILITY" }, {
                        SDO_AC_INVALID_HEARTBEAT_DEC,
                                "SDO_AC_INVALID_HEARTBEAT_DEC" }, {
                        SDO_AC_GEN_INTERNAL_INCOMPATIBILITY,
                                "SDO_AC_GEN_INTERNAL_INCOMPATIBILITY" }, {
                        SDO_AC_ACCESS_FAILED_DUE_HW_ERROR,
                                "SDO_AC_ACCESS_FAILED_DUE_HW_ERROR" }, {
                        SDO_AC_DATA_TYPE_LENGTH_NOT_MATCH,
                                "SDO_AC_DATA_TYPE_LENGTH_NOT_MATCH" }, {
                        SDO_AC_DATA_TYPE_LENGTH_TOO_HIGH,
                                "SDO_AC_DATA_TYPE_LENGTH_TOO_HIGH" }, {
                        ...
                        {
                        SDO_AC_VALUE_RANGE_EXCEEDED,
                                "SDO_AC_VALUE_RANGE_EXCEEDED" }, {
                        SDO_AC_VALUE_RANGE_TOO_HIGH,
                                "SDO_AC_VALUE_RANGE_TOO_HIGH" },
                        {
                        SDO_AC_VALUE_RANGE_TOO_LOW, "SDO_AC_VALUE_RANGE_TOO_LOW" },
                        {
                        SDO_AC_MAX_VALUE_LESS_MIN_VALUE,
                                "SDO_AC_MAX_VALUE_LESS_MIN_VALUE" }, {
                        SDO_AC_GENERAL_ERROR, "SDO_AC_GENERAL_ERROR" }, {
                        SDO_AC_DATA_NOT_TRANSF_OR_STORED,
                                "SDO_AC_DATA_NOT_TRANSF_OR_STORED" }, {
                        SDO_AC_DATA_NOT_TRANSF_DUE_LOCAL_CONTROL,
                                "SDO_AC_DATA_NOT_TRANSF_DUE_LOCAL_CONTROL" }, {
                        SDO_AC_DATA_NOT_TRANSF_DUE_DEVICE_STATE,
                                "SDO_AC_DATA_NOT_TRANSF_DUE_DEVICE_STATE" }, {
                        SDO_AC_OBJECT_DICTIONARY_NOT_EXIST,
                                "SDO_AC_OBJECT_DICTIONARY_NOT_EXIST" }, {
        ...
        static tNmtNodeCommandInfo nmtNodeCommandInfo_l[] =
                {
                        { NmtNodeCommandE::kNmtNodeCommandBoot,
                                "NmtNodeCommandBoot" }, {
                                NmtNodeCommandE::kNmtNodeCommandSwOk,
                                "NmtNodeCommandSwOk" }, {
                                NmtNodeCommandE::kNmtNodeCommandSwUpdated,
                                "NmtNodeCommandSwUpdated" }, {
                                NmtNodeCommandE::kNmtNodeCommandConfOk,
                                "NmtNodeCommandConfOk" }, {
                                NmtNodeCommandE::kNmtNodeCommandConfRestored,
                                "NmtNodeCommandConfRestored" }, {
                                NmtNodeCommandE::kNmtNodeCommandConfReset,
                                "NmtNodeCommandConfReset" }, {
                                NmtNodeCommandE::kNmtNodeCommandConfErr,
                                "NmtNodeCommandConfErr" }, {
                                NmtNodeCommandE::kNmtNodeCommandStart,
                                "NmtNodeCommandStart" }, };

        static tMessageTypeInfo messageTypeInfo_l[] = { {
                MessageType::kMsgTypeNonPowerlink, "NonPowerlink" }, {
                MessageType::kMsgTypeSoc, "SoC" }, { MessageType::kMsgTypeSoa,
                "SoA" }, { MessageType::kMsgTypePreq, "PReq" }, {
                MessageType::kMsgTypePres, "PRes" }, {
                MessageType::kMsgTypeAInv, "AInv" }, {
                MessageType::kMsgTypeAmni, "Amni" }, {
                MessageType::kMsgTypeAsnd, "ASnd" } };
...
//------------------------------------------------------------------------------
        ...
        {
            tMessageTypeInfo* pEntry;
            UINT i;

            pEntry = messageTypeInfo_l;
            for (i = 0; i < tabentries(messageTypeInfo_l); i++)
            {
                if (pEntry->messageType == messageType)
                {
                    return pEntry->sMessageType;
                }
                pEntry++;
            }
            return invalidStr_l;
